...
'''
Now we will be doing feature engineering. We will use backward elimination for
stepwise regression. For that first we need to convert
the categorical variable to int
